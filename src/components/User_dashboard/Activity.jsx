...
export default function Activity() {
  ...
  useEffect(() => {
    ...
    const fetchOrganData = async () => {
      try {
        ...
        const response = await axios.get("http://localhost:5000/allOrganData", {
          headers: {
  ...
  const handleWebinarSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:5000/addWebinar",
        webinar,
        {
          headers: {
            authorization: `Bearer ${token}`,
  ...
  const handleBlogSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("http://localhost:5000/addBlog", blog, {
        headers: {
          authorization: `Bearer ${token}`,
        },
      });
