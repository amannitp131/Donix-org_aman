...
const Dashboard = () => {
    ...
    const fetchHospitalDetails = async () => {
      try {
        ...
        const response = await fetch(
          "http://localhost:5000/getHospitalDetails",
          {
            headers: {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        } bg-gray-100 dark:bg-gray-900 border-r border-gray-300 dark:border-gray-700 md:translate-x-0`}
      >
  ...
  {hospitalDetails ? hospitalDetails.hospitalName : "Loading..."}
            ...
            <li
              ...
              className="flex items-center gap-4 text-gray-700 dark:text-gray-300 font-medium hover:text-blue-500 dark:hover:text-blue-400 transition duration-300 cursor-pointer"
            >
              <IoBagAddOutline className="text-2xl text-gray-500 dark:text-gray-400" />
            ...
            <li
              ...
              className="flex items-center gap-4 text-gray-700 dark:text-gray-300 font-medium hover:text-blue-500 dark:hover:text-blue-400 transition duration-300 cursor-pointer"
            >
              <RiFindReplaceLine className="text-2xl text-gray-500 dark:text-gray-400" />
            ...
            <li
              ...
              className="flex items-center gap-4 text-gray-700 dark:text-gray-300 font-medium hover:text-blue-500 dark:hover:text-blue-400 transition duration-300 cursor-pointer"
            >
              <VscLayoutActivitybarLeft className="text-2xl text-gray-500 dark:text-gray-400" />
          ...
          <ul className="space-y-6">
            <li
              ...
              className="flex items-center gap-4 text-gray-500 dark:text-gray-400 hover:text-green-500 transition duration-300 cursor-pointer"
            >
            ...
            <li
              ...
              className="flex items-center gap-4 text-gray-500 dark:text-gray-400 hover:text-red-600 transition duration-300 cursor-pointer"
            >
      ...
      {/* Mobile Menu Button */}
      {!isSidebarOpen && (
        <div className="fixed top-0 left-0 w-full h-9 z-50 flex justify-start md:hidden bg-gray-100 dark:bg-gray-900">
          <button
